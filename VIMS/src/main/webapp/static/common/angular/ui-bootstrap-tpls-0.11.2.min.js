 ...
 * 
 * templateUrl://模态窗口的地址
 * template:"<div style='width:1200px;height:600px;'>个人信息</div>",//用于显示html标签
 * scope:false,//一个作用域为模态的内容使用（事实上，$modal会创建一个当前作用域的子作用域）默认为$rootScope
 ...
 * controllerAs: // 给模态框命名一个ng-controller
